...
var buttonsByClass =
    document.getElementsByClassName("shape-btn");
...
if (allButtons.length > 0) {
    ...
    do {
        ...
        let currentBtn = allButtons[i];


        // onmouseover
        currentBtn.onmouseover = function() {

            currentBtn.style.backgroundColor = "#e0e0e0";
        ...
        currentBtn.onmouseout = function() {
            ...
            currentBtn.style.backgroundColor = "#f9f9f9";
